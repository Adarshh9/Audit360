...
def generate_text_from_file(filepath: str) -> str:
    try:
        ...
        prompt = 'Provide a professional risk and threat report based on non compliance audit results: '
...
def main(filepath: str):
    ...
    with open("threats.txt", "w") as result_file:
        result_file.write(result)

    print("Result saved to threats.txt.")
